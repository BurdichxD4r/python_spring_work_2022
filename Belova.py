...
print('Случайно выбранное число из последовательности:    ', randrange(start, stop, step), '\n\t' + 'start =', start,
      '; stop =', stop, '; step =', step, '\n')
# Задача для randrange:
# В магазине проводится акция, каждому виду товара на кассе случайно определяется скидка в 5, 10 или 15
# процентов. Реализуйте эту программу, которая будет выдавать чек, и писать сколько процентов скидки получилось от всей
# суммы покупки.
print('''Задача для randrange:
В магазине проводится акция, каждому виду товара на кассе случайно определяется скидка в 5, 10 или 15
процентов. Реализуйте эту программу, которая будет выдавать чек, и писать сколько процентов скидки получилось от всей
суммы покупки.''' + '\n')
milk = 80
...
all_summ = 0
sell_summ = 0
list_product = [milk, cookies, sugar, cucumber * 2]
for i in list_product:
    all_summ += float(i)
    sell_summ += i - (i * randrange(5, 15, 5) / 100)
print('Итого к оплате: ' + str(sell_summ) + 'руб.\nСумма скидки составила: ' + str(all_summ - sell_summ) + 'руб.\n')
...
#Задача для randint:
# Выведите сколько попыток потребуется, чтобы набрать 50 или больше очков в игре в кости (2 кубика, на каждой стороне
# числа от 1 до 6)
print('Задача для randint:\nВыведите сколько попыток потребуется, чтобы набрать 50 или больше очков в игре в кости (2'
      'кубика,\nна каждой стороне числа от 1 до 6)\n')
quantity_point = 0
attempt = 0
while quantity_point < 50:
    cube_1 = randint(1, 6)
    cube_2 = randint(1, 6)
    quantity_point += cube_1 + cube_2
    attempt += 1
print('Вы дошли до результата:', quantity_point, 'очков!\nПопыток потребовалось:', attempt, '\n')
